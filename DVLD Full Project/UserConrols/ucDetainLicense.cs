...
namespace DVLD_Full_Project.UserConrols
{
    public partial class ucDetainLicense : UserControl
    {
        ...
        private void _LoadDriverLicenseInfos()
        {
            ...
            {
                MessageBox.Show("Driver License Already Detained, choose a released one");
            ...
            {
                MessageBox.Show("Driver License not Active, You can not detain non Active license, choose another one please");
